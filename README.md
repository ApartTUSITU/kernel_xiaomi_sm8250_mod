...
Release 里的编译好的内核成品由 `android16-aptusitu` 分支编译，应当能在原版 MIUI/HyperOS 和第三方的基于 AOSP 的各种 Android11-16 的 ROM 上使用。欢迎大家尝试并反馈(提 Issue 或 Pull Requests)! 酷友们到 [酷安的这个帖子](https://www.coolapk.com/feed/67088487) 讨论或反馈，也可以给我私信反馈!  
